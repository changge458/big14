...
public class Gz2Seq {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DeflateCodec codec2 = ReflectionUtils.newInstance(DeflateCodec.class, conf);

        SequenceFile.Writer writer = SequenceFile.createWriter(fs, conf, new Path("D:/teaching/avro/gz2seq.seq"), NullWritable.class, Text.class
                , SequenceFile.CompressionType.BLOCK, codec2);
