package com.oldboy.music164.udtf;

import com.oldboy.music164.columnutil.Log_Usage_Column_Util;
import com.oldboy.music164.constant.Constants;
import com.oldboy.music164.util.ParseKeyUtil;
...
public class ParseUsage extends GenericUDTF {
    ...
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        ...
        //构造的字段名称集合
        ArrayList<String> fieldNames = Log_Usage_Column_Util.list;
    ...
    public void process(Object[] args) throws HiveException {
        ...
        String tablename = PropUtil.getValue(Constants.USAGE_TABLE_NAME);
