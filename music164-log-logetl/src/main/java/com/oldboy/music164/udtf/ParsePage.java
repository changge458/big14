...
import com.oldboy.music164.columnutil.Log_Page_Column_Util;
...
public class ParsePage extends GenericUDTF {
    ...
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        ...
        //构造的字段名称集合
        ArrayList<String> fieldNames = Log_Page_Column_Util.list;
    ...
    public void process(Object[] args) throws HiveException {
        ...
        String tablename = PropUtil.getValue(Constants.PAGE_TABLE_NAME);
