...
import com.oldboy.music164.columnutil.Log_Error_Column_Util;
...
public class ParseError extends GenericUDTF {
    ...
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        ...
        //构造的字段名称集合
        ArrayList<String> fieldNames = Log_Error_Column_Util.list;
    ...
    public void process(Object[] args) throws HiveException {
        ...
        String tablename = PropUtil.getValue(Constants.ERROR_TABLE_NAME);
