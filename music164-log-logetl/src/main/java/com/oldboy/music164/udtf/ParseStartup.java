...
import com.oldboy.music164.columnutil.Log_Startup_Column_Util;
...
public class ParseStartup extends GenericUDTF {
    ...
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        ...
        //构造的字段名称集合
        ArrayList<String> fieldNames = Log_Startup_Column_Util.list;
